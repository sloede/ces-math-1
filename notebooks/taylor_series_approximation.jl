...
@bind n Slider(0:20, default=1, show_value=true)

# ╔═╡ 751a3032-2dc1-4b35-a89f-6108daf02642
md"""
...
md"""
### Definitions for derivative functions
The following includes definitions for the `nth_derivative` function that is used in the `taylor_polynomial` function to compute the Taylor polynomial.
"""

# ╔═╡ 6b8ce6e6-12fc-4c7d-a6c3-44c93babfbdf
"""
    nth_derivative(f, n, x)

Evaluate the `n`-th derivative of the function `f` at position `x`. This function is used to compute the derivative inside the `taylor_polynomial` function. To support more functions, add a new method that dispatches on the function type.
"""
function nth_derivative(f, n, x) end
...
md"""
### Definition of the `taylor_polynomial` function
"""
...
begin
    ...
    plot!(xvalues, taylor_values_limited, label=L"T_{%$n}(x)", linewidth=3)

	# Plot marker at x0
	scatter!([x0], [selected_function(x0)], label=L"x_0", markersize=5, markercolor=:red)
end
